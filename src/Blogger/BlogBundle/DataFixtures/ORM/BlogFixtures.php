...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog2->setImageName('pool_leak.jpg');
        ...
        $blog3->setImageName('misdirection.jpg');
        ...
        $blog4->setImageName('the_grid.jpg');
        ...
        $blog5->setImageName('one_or_zero.jpg');
